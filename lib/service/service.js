...
const ErrorStore = require('./error_store')
...
class Service {
    ...
    */
    async init(conf) {
        ...
        await this._message_store.init()

        this._error_store = new ErrorStore(this._store)
        await this._error_store.init()
