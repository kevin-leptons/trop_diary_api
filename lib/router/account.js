...
get('/', async (req, res) => {
    ...
    schema.verify_request('//trop/front/get_account', req)
...
post('/', async (req, res) => {
    ...
    let schema = req.service.get(Schema)
    schema.verify_request('//trop/front/post_account', req)
...
patch('/password', async (req, res) => {
    ...
    let schema = req.service.get(Schema)
    schema.verify_request('//trop/front/patch_account_password', req)
...
patch('/role', async (req, res) => {
    ...
    let schema = req.service.get(Schema)
    schema.verify_request('//trop/front/patch_account_role', req)
...
delete('/item/:username', async (req, res) => {
    ...
    let schema = req.service.get(Schema)
    schema.verify_request('//trop/front/del_account', req)
