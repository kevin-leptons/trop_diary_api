...
get('/', async (req, res) => {
    ...
    schema.verify_request('//trop/front/get_message', req)
...
get('/item/:id', async (req, res) => {
    ...
    let schema = req.service.get(Schema)
    schema.verify_request('//trop/front/get_message_item', req)
...
post('/', async (req, res) => {
    ...
    let schema = req.service.get(Schema)
    schema.verify_request('//trop/front/post_message', req)
